...
<div class="container">
    ...
    <div class="form-section">
        <h2>consultar usuario con permiso</h2>

        <form action="{{ route('permisos.consultar') }}" method="POST">
            @csrf
            ...
            <div class="form-group" id="campo-busqueda" style="display: none;">
                <input type="text" name="busqueda" placeholder="Escribe el email">
            </div>
...
<script>
    function toggleBusqueda(value) {
        document.getElementById('campo-busqueda').style.display = (value === 'email') ? 'block' : 'none';
    }
</script>
@endsection
