...
<div class="container">
    ...
    <div class="form-section">
        ...
        <form action="{{ route('tipoDocumento.guardar') }}" method="POST">
            @csrf
            <div class="form-group">
                <label for="nombre">nombre de tipo documento</label>
                <input type="text" name="nombre" required>
            </div>

            <div class="form-group">
                <label for="descripcion">descripcion tipo documento</label>
